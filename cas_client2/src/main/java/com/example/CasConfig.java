...
public class CasConfig extends WebSecurityConfigurerAdapter {
    ...
    public ServiceProperties serviceProperties() {
        ...
        serviceProperties.setService("http://app2.com:8996/login/cas"); //默认就是/login/cas
...
//                .antMatchers("/login/cas").permitAll() //不用设置,会被 casAuthenticationFilter 过滤器拦截处理
    ...
    public LogoutFilter logoutFilter() {
        LogoutFilter filter =
                new LogoutFilter("http://www.cas.server.com:8080/cas/logout?service=http://app2.com:8996/logout"
